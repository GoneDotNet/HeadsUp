...
public class AiQuestionService(IChatClient chatClient) : IQuestionService
{
    ...
    public async Task<string[]> GetQuestions(string category, int count, CancellationToken cancellationToken)
    {
